...
This shows that it's possible to choose a proportional value and rescale the entire objective to have maximum functional margin = 1. Therefore, rescaling we get the our objective function as, 
