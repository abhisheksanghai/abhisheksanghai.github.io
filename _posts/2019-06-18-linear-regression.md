...
I will write a separate post explaining the [Assumptions of Linear Regression](https://abhisheksanghai.com/2019/07/14/assumptions_linear_regression) and its 
[usage on a dataset](/Algorithms_in_Action/Linear_regression.ipynb).
